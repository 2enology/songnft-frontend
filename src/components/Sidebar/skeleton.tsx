export const SideBarSkeleton = () => {
  return (
    <div
      className={`hidden top-0 left-0 lg:w-[250px] xl:w-[300px] lg:bg-[#000000] duration-200 transition-all bg-[#161616] z-[9999] border-r-[1px] border-[#2C2C2C] h-full flex-col items-center justify-start gap-5 fixed lg:flex 
